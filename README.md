...
```bash
wget -O PalServerInstall.sh https://ghfast.top/https://raw.githubusercontent.com/notetoday/Pal-Server-Install/main/PalServerInstall.sh && chmod +x PalServerInstall.sh && ./PalServerInstall.sh
```
